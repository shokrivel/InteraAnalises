        ...
        <div style={{maxWidth:300}}>
          ...
          {sent?(
            <div style={{background:'rgba(59,77,160,0.08)',border:'1px solid #3b4da0',borderRadius:10,padding:20,marginTop:16,textAlign:'center'}}>
              ...
              <div style={{fontSize:12,color:'#888',marginTop:4}}>Retornaremos em at\u00e9 24h.</div>
            </div>
          ):(
      ...
      <div className="ia-root">
        <div className="ia-left">
          ...
          <div className="ia-hero">
            ...
            <div className="ia-diag">Diagn\u00f3sticos direcionais</div>
          </div>
        </div>
        <div className={`ia-right${active?' expanded':''}`}>
          <div className="ia-menu">
            {MENU.map(item=>(
              <button key={item.id} className={`ia-item${active===item.id?' active':''}`} onClick={()=>toggle(item.id)}>
