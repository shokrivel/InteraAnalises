...
-- Drop existing policies and recreate with moderator access
...
DROP POLICY IF EXISTS "Everyone can view active consultation fields" ON public.consultation_fields;
DROP POLICY IF EXISTS "Admins and moderators can view consultation fields" ON public.consultation_fields;
DROP POLICY IF EXISTS "Only admins can manage consultation fields" ON public.consultation_fields;

-- Allow everyone to view active fields, admins and moderators to view all
